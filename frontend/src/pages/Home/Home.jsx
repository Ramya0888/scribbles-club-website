...
const deputyHeads = [
  ...
  { name: 'Abirami', role: 'Web & Tech', dept: 'CSE', image: '/team/abi.webp', instagram: '', linkedin: '', quote: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.' },
  { name: 'Hashim M', role: 'Web & Tech', dept: 'CSE', image: '/team/has.jpeg', instagram: '', linkedin: '', quote: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.' },
  { name: 'Ramya S', role: 'Web & Tech', dept: 'CSE', image: '/team/ramy.jpg', instagram: '', linkedin: '', quote: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.' },
    ...
    <header className="hero" id="top">
      ...
      <div className="hero-text">
        ...
        <div className="hero-actions">
          ...
          <Link className="btn ghost" to="/gallery">See the Gallery</Link>
    ...
    <section id="about-section" className="section" style={{ paddingTop: '6rem' }}>
      <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
        ...
        <div style={{ marginTop: '2rem', display: 'flex', gap: '0.75rem', justifyContent: 'center', flexWrap: 'wrap' }}>
          ...
          <Link to="/gallery" className="btn ghost">Our Gallery</Link>
