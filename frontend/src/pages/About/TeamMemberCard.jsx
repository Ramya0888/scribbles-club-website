...
function TeamMemberCard({ name, role, dept, image, instagram, linkedin, quote, onClick }) {
  ...
  return (
    <div className="card" style={{ width: 240, minHeight: 420, textAlign: 'center', cursor: 'url("/cur-swatch.png") 17 21, url("/cur-swatch-128.png") 68 85, pointer', padding: '0.85rem', borderRadius: 18 }} onClick={onClick}>
