...
const officeBearers = [
  ...
  { name: "Lavanyalakshmi", role: "Past Secretary", image: "/team/lav.webp", quote: "From scouting venues to hunting for paint at the last minute, every event was chaos — and I'd do it all over again." },
  { name: "Ramkumar S", role: "Past Treasurer", image: "/team/ram.webp", quote: "I joined to draw and stayed for the people. The budget sheets were never pretty, but the friendships always were." },
  { name: "Mahima S", role: "Past Events Head", image: "/team/mah.webp", quote: "Planning speed art events taught me how a little music, a lot of enthusiasm, and one shared wall can bring a whole college together." },
  { name: "Suren M", role: "Past Events Head", image: "/team/sur.webp", quote: "Scribbles is where I learned that the best ideas are drawn in chalk, erased, and drawn again — often mid-event." },
...
const alumni = [
  { name: "Dharshini E", role: "Alumni, Social Media", image: "/team/dharsE.webp", quote: "Even after graduation, Scribbles still sends me updates faster than my friends do. Once family, always family." },
  { name: "Roopa Varshni R", role: "Alumni, Creatives", image: "/team/roop.webp", quote: "The late-night poster sessions and the smell of paint thinner — I genuinely miss every bit of it." },
  { name: "Sadha Shree N", role: "Alumni, Marketing", image: "/team/sad.webp", quote: "Scribbles taught me that engagement beats reach, and that a hand-painted hoarding beats any banner ad." },
  { name: "Devika S", role: "Alumni, Marketing", image: "/team/dev.webp", quote: "Some of my closest friends today are people I first met holding a flattened paintbrush at fresher's ink." },
  { name: "Rishitha K P", role: "Alumni, Events", image: "/team/image.webp", quote: "If you ever see me at a resale paint stall, it's because Scribbles rewired things: I look at art supply prices for fun now." },
  { name: "Santoshi", role: "Alumni, Coordinator", image: "/team/sant.webp", quote: "Our coordinator badge was heavier than it looked, but the clap when an event goes right was worth everything." },
  { name: "Yazhvendhan", role: "Alumni, Coordinator", image: "/team/yaz.webp", quote: "I joined for the lettering workshops. I stayed because of the people who have since left — and the ones who never will." },
];
...
const webTeam = [
  ...
  { name: "Hashim M", role: "Web Development Team", image: "/team/has.webp", linkedin: "https://www.linkedin.com/in/hashim-m-160b96340/", quote: "Shipping the new site felt exactly like finishing a mural: paint inspection by everyone, and then applause." },
  { name: "Ramya S", role: "Web Development Team", image: "/team/ramy.webp", linkedin: "https://www.linkedin.com/in/ramyalnkdn/", quote: "The club taught me that a website is art too — and that we get to choose the palette." },
